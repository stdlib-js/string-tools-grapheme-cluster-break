...
```javascript
import grapheme from 'https://cdn.jsdelivr.net/gh/stdlib-js/string-tools-grapheme-cluster-break@v0.2.0-esm/index.mjs';
```

You can also import the following named exports from the package:

```javascript
import { breakProperty, breakType, constants, emojiProperty } from 'https://cdn.jsdelivr.net/gh/stdlib-js/string-tools-grapheme-cluster-break@v0.2.0-esm/index.mjs';
```
